...
// เชื่อมต่อบอร์ดอัตโนมัติตอนโหลดหน้า ถ้าอยู่ใน Board mode และเคยบันทึก URL
// ของบอร์ดไว้แล้ว (ไม่ต้องกดปุ่ม/กรอก URL ใหม่ทุกครั้งที่รีเฟรชหน้า)
// silent=true เพื่อไม่ให้ขึ้น alert popup รบกวนถ้าบอร์ดยังไม่พร้อม/ปิดอยู่
if (getMode() === 'board') {
    connectToBoard(true);
}
